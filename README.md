...
We will spend about 5 minutes on each step. 
If you get lost or something doesn't work, you can still follow along, and later tonight try again as if you were Tier 1.
...
- **If you rolled 1: you are in Group A.**
- **If you rolled 2: you are in Group B.**

## Step 2 - Group A forking

If you are in Group A, click the **Fork** button at the top right of this page, then click **Create Fork**.
...
Group B: Wait, and watch the fork stucture.

## Step 3 - Group B forking
...
## Step 4 - Everyone: pick a line and change it.

Everyone make sure you are in your repo.
...
- Click **Create pull request**, then **Create pull request** again (to confirm).

## Step 6 - Group A accept the Pull Requests

If you are in Group A:

- Click the **Pull requests** tab (horizontal menu, a bit below the top of the page).
- Open the pending pull request and click **Merge pull request**.

**If it says "This branch has conflicts that must be resolved",**
then stop and discuss with the class.
We will merge the conflict together.
...
## Step 7 - Group A send everything to Jun

If you are in Group A:

Click the **Pull requests** tab at the top.
- Click **New pull request**.
- You should see your change on the right, and Jun's copy on the left.
- Click **Create pull request**, then **Create pull request** again (to confirm).
